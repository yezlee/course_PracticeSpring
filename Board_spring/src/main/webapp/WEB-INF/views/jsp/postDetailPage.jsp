...
<script type="text/javascript">
	...
	$(function(){
		$("#modifyBtn").on("click", function(){
			$("#post_no").val.$("${boardList.post_no}")
			$("#bd_no").val.$("${boardList.bd_no}")
			$("#writer").val.$("${boardList.writer}")
			$("#frm_post").attr("method", "get")
			$("#frm_post").attr("action", "/board/modifyPost")
			$("#frm_post").submit()
		})
				...
				<div class="table-responsive">
					...
					<div class="container">
						...
						<form id="frm_post">
							...
							<input type="hidden" id="bd_no" name="bd_no"  /> 
