	    ...
	    <%@ include file ="/common/common_left_nav.jsp" %>
          ...
          <div class="table-responsive">
			...
			<div class="container">
			  ...
			  <form action="${pageContext.request.contextPath}/createPost.do" method="post">
 				 <input type="hidden" name="boardNo" value="${boardNo}">
 				 <input type="hidden" name="userId" value="${S_USER.userid}">
 				 
				  <div>
				  	<strong>제목</strong>
				  	<span><input type="text" name="title" value="" placeholder="제목을 입력하세요"/></span>
				  </div>
				  <div>
				  	<strong>내용</strong>
				  	<span><textarea id="summernote" name="editordata"></textarea></span>
				  </div>
				  <div>
				  	<strong>첨부파일</strong>
				  	<span><input type="button" name="file" value="첨부파일 추가하기" /></span>
				  </div>
				  <div>
				  	<strong>댓글</strong>
				  	<span><input type="text" name="reply" value="" placeholder="댓글을 입력하세요"/></span>
				  	<span><input type="button" name="replyBtn" value="댓글입력하기" /></span>
				  </div>
