	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				...
				<form action="${pageContext.request.contextPath}/loginController.do" id="frm" method="post">
					...
					<div class="row">
						<div class="col-sm-8">
							<div class="checkbox icheck">
								<label> <input type="checkbox" id="rememberme" checked="checked" name="rememberme"> Remember Me</label>
							</div>
						</div>
						<!-- /.col -->
