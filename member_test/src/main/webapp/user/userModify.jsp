					...
					<div class="container-fluid">
						...
						<div class="card">
							<div class="register-card-body">
								...
								<form method="post" class="form-horizontal" id="frm" role="form" action="${pageContext.request.contextPath}/userModify.do" enctype="multipart/form-data">
									...
									<div class="input-group mb-3">
										...
										<div class="mailbox-attachments clearfix" style="text-align: center; width:100%;">
											...
											<div class="mailbox-attachment-icon has-img" id="pictureView" style="border: 1px solid green; height: 200px; width: 140px; margin: 0 auto;">
												<img id="pictureViewImg" src="${pageContext.request.contextPath}/profileServlet.do?userid=${user.userid}">
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group input-group-sm">
											<input type="text" class="form-control" id="userAlias" name="userAlias" value="${user.alias}">
										</div>
									</div>
